 ...
 * @returns {vec2} a new 2D vector
 */
function vec2_fromValues(_x, _y) {
	return [_x, _y];
}
/**
 ...
 * @returns {vec2} out
 */
function vec2_random(out, scale=1.0) {
 ...
 * @returns {vec2} out
 */
function vec2_transformMat2(out, a, m) {
  var _x = a[0],
    _y = a[1];
  out[0] = m[0] * _x + m[2] * _y;
  out[1] = m[1] * _x + m[3] * _y;
 ...
 * @returns {vec2} out
 */
function vec2_transformMat2d(out, a, m) {
  var _x = a[0],
    _y = a[1];
  out[0] = m[0] * _x + m[2] * _y + m[4];
  out[1] = m[1] * _x + m[3] * _y + m[5];
  return out;
}
/**
...
function vec2_transformMat3(out, a, m) {
  var _x = a[0],
    _y = a[1];
  out[0] = m[0] * _x + m[3] * _y + m[6];
  out[1] = m[1] * _x + m[4] * _y + m[7];
  return out;
}
/**
...
function vec2_transformMat4(out, a, m) {
  var _x = a[0];
  var _y = a[1];
  out[0] = m[0] * _x + m[4] * _y + m[12];
  out[1] = m[1] * _x + m[5] * _y + m[13];
  return out;
}
/**
 * Rotate a 2D vector
...
function vec2_angle(a, b) {
  ...
  // min(max(cosine, -1), 1) clamps the cosine between -1 and 1
